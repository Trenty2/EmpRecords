...
namespace EmpRecords.Controllers
{
    public class StandardsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,LastName,FirstName,StartingDate")] Standard standard)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,LastName,FirstName,StartingDate")] Standard standard)
        {
            if (id != standard.ID)
            {
                return NotFound();
